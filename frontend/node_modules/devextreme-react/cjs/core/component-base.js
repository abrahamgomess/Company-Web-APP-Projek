...
const ComponentBase = (0, react_1.forwardRef)((props, ref) => {
    ...
    const restoreParentLinkRef = (0, react_1.useRef)(restoreParentLink);
    ...
    const createWidgetRef = (0, react_1.useRef)(createWidget);
    (0, react_1.useLayoutEffect)(() => {
    ...
    const renderPortal = (0, react_1.useCallback)(() => portalContainer.current && (0, react_dom_1.createPortal)(_renderChildren(), portalContainer.current), [_renderChildren]);
