...
class OptionsManager {
    ...
    onOptionChanged(e) {
        ...
        if (value instanceof Array && type === tree_1.ValueType.Array) {
            ...
            Object.keys(value).forEach((key) => {
                ...
                this.addGuard((0, utils_1.mergeNameParts)(e.fullName, key), value[key], newValue);
            });
        }
        else {
    ...
    setValue(name, value) {
        if (this.guards[name]) {
            try {
                if ((0, comparer_1.compareValues)(this.guards[name].latestValue, value)) {
                    return;
                }
            }
            finally {
