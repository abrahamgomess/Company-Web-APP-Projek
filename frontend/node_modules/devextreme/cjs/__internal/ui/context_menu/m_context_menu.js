...
class ContextMenu extends _m_menu_base.default {
    ...
    _getItemsContainers() {
        var _this$_overlay2;
        return (null === (_this$_overlay2 = this._overlay) || void 0 === _this$_overlay2 || null === (_this$_overlay2 = _this$_overlay2.$content()) || void 0 === _this$_overlay2 ? void 0 : _this$_overlay2.find(".dx-menu-items-container")) ?? (0, _renderer.default)()
    }
    ...
    _hideAllShownSubmenus() {
        var _this$_overlay3;
        const shownSubmenus = (0, _extend.extend)([], this._shownSubmenus);
        const $expandedItems = (null === (_this$_overlay3 = this._overlay) || void 0 === _this$_overlay3 || null === (_this$_overlay3 = _this$_overlay3.$content()) || void 0 === _this$_overlay3 ? void 0 : _this$_overlay3.find(".dx-menu-item-expanded")) ?? (0, _renderer.default)();
        $expandedItems.removeClass("dx-menu-item-expanded");
