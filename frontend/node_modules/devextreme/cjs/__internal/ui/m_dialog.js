...
const custom = function(options) {
    var _popupInstance$$wrapp, _popupInstance$$wrapp2;
    ...
    const popupInstance = new _ui.default($element, (0, _extend.extend)({
        ...
        onContentReady(args) {
            var _args$component$$cont;
            null === (_args$component$$cont = args.component.$content()) || void 0 === _args$component$$cont || _args$component$$cont.addClass("dx-dialog-content").append($message);
            if (messageId) {
                var _args$component$$over;
                null === (_args$component$$over = args.component.$overlayContent()) || void 0 === _args$component$$over || _args$component$$over.attr("aria-labelledby", messageId)
            }
        },
        onShowing(e) {
        ...
        onHidden: _ref2 => {
            ...
            (0, _renderer.default)(element).remove();
            null === (_options$popupOptions = options.popupOptions) || void 0 === _options$popupOptions || null === (_options$popupOptions2 = _options$popupOptions.onHidden) || void 0 === _options$popupOptions2 || _options$popupOptions2.call(_options$popupOptions, {
                element: element
            })
        }
    }));
    ...
    null === (_popupInstance$$wrapp = popupInstance.$wrapper()) || void 0 === _popupInstance$$wrapp || _popupInstance$$wrapp.addClass("dx-dialog-wrapper");
    if (options.position) {
        popupInstance.option("position", options.position)
    }
    null === (_popupInstance$$wrapp2 = popupInstance.$wrapper()) || void 0 === _popupInstance$$wrapp2 || _popupInstance$$wrapp2.addClass("dx-dialog-root");
