...
class Toast extends _ui.default {
    ...
    _render() {
        var _this$$element, _this$$wrapper, _this$$content, _this$$content2;
        super._render();
        ...
        null === (_this$$content = this.$content()) || void 0 === _this$$content || _this$$content.addClass("dx-toast-" + String(type).toLowerCase());
    ...
    _optionChanged(args) {
        var _this$$content3, _this$$content4;
        const {
            name: name,
            value: value,
