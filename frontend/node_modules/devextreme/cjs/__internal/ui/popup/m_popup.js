...
class Popup extends _m_overlay.default {
    ...
    _init() {
        ...
        this._$popupContent = null === (_this$_$content = this._$content) || void 0 === _this$_$content ? void 0 : _this$_$content.wrapInner((0, _renderer.default)("<div>").addClass("dx-popup-content")).children().eq(0);
    ...
    _renderTitle() {
        ...
        if (showTitle || items.length > 0) {
            var _this$_$title;
            null === (_this$_$title = this._$title) || void 0 === _this$_$title || _this$_$title.remove();
            const $title = (0, _renderer.default)("<div>").addClass("dx-popup-title");
    ...
    _toggleAriaLabel() {
        ...
        null === (_this$_$title2 = this._$title) || void 0 === _this$_$title2 || _this$_$title2.find(".dx-toolbar-label").eq(0).attr("id", titleId);
    ...
    _renderBottom() {
        ...
        if (items.length) {
            ...
            const $bottom = (0, _renderer.default)("<div>").addClass("dx-popup-bottom");
            const $content = this.$content();
            if ($content) {
    ...
    _toggleClasses() {
        ...
        (0, _iterator.each)(aliases, ((_, alias) => {
            ...
            if (this._toolbarItemClasses.includes(className)) {
                var _this$$wrapper2, _this$_$bottom3;
                null === (_this$$wrapper2 = this.$wrapper()) || void 0 === _this$$wrapper2 || _this$$wrapper2.addClass(`${className}-visible`);
                null === (_this$_$bottom3 = this._$bottom) || void 0 === _this$_$bottom3 || _this$_$bottom3.addClass(className)
            } else {
                var _this$$wrapper3, _this$_$bottom4;
                null === (_this$$wrapper3 = this.$wrapper()) || void 0 === _this$$wrapper3 || _this$$wrapper3.removeClass(`${className}-visible`);
    ...
    _dispose() {
        ...
        this._$title = void 0;
        this._$bottom = void 0;
        this._$popupContent = void 0
    }
