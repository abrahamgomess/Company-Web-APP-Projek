...
class SpeedDialMainItem extends _m_speed_dial_item.default {
    ...
    _clickHandler() {
        ...
        for (let i = 0; i < actions.length; i++) {
            var _actions$i$_$wrapper, _this$_$wrapper;
            ...
            null === (_actions$i$_$wrapper = actions[i]._$wrapper) || void 0 === _actions$i$_$wrapper || _actions$i$_$wrapper.css("position", null === (_this$_$wrapper = this._$wrapper) || void 0 === _this$_$wrapper ? void 0 : _this$_$wrapper.css("position"));
            actions[i].toggle()
        }
    ...
    _outsideClickHandler(e) {
        if (this._isShadingShown) {
            var _this$_$wrapper2;
            const isShadingClick = (0, _renderer.default)(e.target)[0] === (null === (_this$_$wrapper2 = this._$wrapper) || void 0 === _this$_$wrapper2 ? void 0 : _this$_$wrapper2[0]);
            if (isShadingClick) {
                e.preventDefault();
                this._clickHandler()
            }
