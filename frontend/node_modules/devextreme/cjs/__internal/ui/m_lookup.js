...
class Lookup extends _m_drop_down_list.default {
    ...
    _renderPopover() {
        ...
        const options = (0, _extend.extend)(popupConfig, this.option("_userDropDownOptions"), {
            showEvent: null,
            hideEvent: null,
            target: this.$element(),
            fullScreen: false,
    ...
    _toggleSearchClass(isSearchEnabled) {
        var _this$_popup2;
        null === (_this$_popup2 = this._popup) || void 0 === _this$_popup2 || null === (_this$_popup2 = _this$_popup2.$wrapper()) || void 0 === _this$_popup2 || _this$_popup2.toggleClass("dx-lookup-popup-search", isSearchEnabled)
    }
    ...
    _runWithoutCloseOnScroll(callback) {
        ...
        const hideOnParentScroll = null === (_this$_popup3 = this._popup) || void 0 === _this$_popup3 ? void 0 : _this$_popup3.option("hideOnParentScroll");
        if (!_scrollToSelectedItemEnabled) {
            callback()
        } else {
            var _this$_popup4;
            null === (_this$_popup4 = this._popup) || void 0 === _this$_popup4 || _this$_popup4.option("hideOnParentScroll", false);
            callback();
            this._hideOnParentScrollTimer = setTimeout((() => {
                var _this$_popup5;
                null === (_this$_popup5 = this._popup) || void 0 === _this$_popup5 || _this$_popup5.option("hideOnParentScroll", hideOnParentScroll)
            }))
        }
    }
    _setFocusPolicy() {
