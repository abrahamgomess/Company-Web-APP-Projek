...
var _m_toolbarMenu = _interopRequireWildcard(require("./m_toolbar.menu.list"));
...
class DropDownMenu extends _widget.default {
    ...
    _popupKeyHandler(e) {
        if ((0, _renderer.default)(e.target).closest(`.${_m_toolbarMenu.TOOLBAR_MENU_ACTION_CLASS}`).length) {
            this._closePopup()
        }
    }
    _closePopup() {
