...
class EditingControllerImpl extends _m_modules.default.ViewController {
    ...
    _addInternalData(params) {
        ...
        this._internalState.set((0, _common.getKeyHash)(params.key), _extends({}, internalData, params));
        return params
    }
    _getOldData(key) {
    ...
    updateInternalDataKey(oldKey, newKey) {
        ...
        this._addInternalData(_extends({}, internalData, {
            key: newKey
        }))
    }
    ...
    _fireSaveEditDataEvents(changes) {
        (0, _iterator.each)(changes, ((_, _ref) => {
            ...
            if (null !== internalData && void 0 !== internalData && internalData.error) {
                params.error = internalData.error
            }
            switch (type) {
                case _const.DATA_EDIT_DATA_REMOVE_TYPE:
                    this.executeAction("onRowRemoved", _extends({}, params, {
                        data: null === internalData || void 0 === internalData ? void 0 : internalData.oldData
                    }));
                    break;
                case _const.DATA_EDIT_DATA_INSERT_TYPE:
