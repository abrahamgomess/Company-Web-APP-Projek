...
class GridCoreModel {
    ...
    getCellElement(rowIndex, columnIndex) {
        ...
        return null === (_this$root$querySelec = this.root.querySelectorAll(`.${SELECTORS.dataRowClass}`)[rowIndex]) || void 0 === _this$root$querySelec ? void 0 : _this$root$querySelec.querySelectorAll("td")[columnIndex]
    }
    getGroupRows() {
