...
class CompactAppointmentsHelper {
    ...
    _createTooltipInfos(items) {
        return items.data.map(((appointment, index) => {
            var _items$settings, _items$colors, _items$settings2;
            ...
            const tooltipInfo = {
                ...
                color: (null === (_items$colors = items.colors) || void 0 === _items$colors ? void 0 : _items$colors[index]) ?? [],
                settings: (null === (_items$settings2 = items.settings) || void 0 === _items$settings2 ? void 0 : _items$settings2[index]) ?? []
            };
            return tooltipInfo
        }))
    }
