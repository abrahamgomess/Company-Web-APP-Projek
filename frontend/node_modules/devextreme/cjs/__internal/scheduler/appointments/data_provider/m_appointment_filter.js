...
class AppointmentFilterBaseStrategy {
    ...
    get timezone() {
        return this._resolveOption("timezone")
    }
    get firstDayOfWeek() {
        ...
        return [
            [appointment => {
                ...
                if (!hasRecurrenceRule) {
                    const isInDisplayRange = isAllDay ? endDate >= trimMin && startDate < trimMax : endDate > trimMin && startDate < trimMax;
                    if (!(isInDisplayRange || _date.default.sameDate(endDate, trimMin) && _date.default.sameDate(startDate, trimMin))) {
                        return false
                    }
                }
