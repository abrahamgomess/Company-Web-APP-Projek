...
class Menu extends MenuBase {
    ...
    _initAdaptivity() {
        ...
        null === (_this$_overlay$$conte = this._overlay.$content()) || void 0 === _this$_overlay$$conte || _this$_overlay$$conte.append(this._treeView.$element()).addClass(DX_ADAPTIVE_MODE_CLASS).addClass(this.option("cssClass"));
    ...
    _submenuMouseLeaveHandler($rootItem, eventArgs) {
        var _this$_getSubmenuByRo;
        const target = $(eventArgs.relatedTarget).parents(".dx-context-menu")[0];
        const contextMenu = null === (_this$_getSubmenuByRo = this._getSubmenuByRootElement($rootItem).getOverlayContent()) || void 0 === _this$_getSubmenuByRo ? void 0 : _this$_getSubmenuByRo[0];
