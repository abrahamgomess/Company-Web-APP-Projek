...
class ContextMenu extends MenuBase {
    ...
    _getItemsContainers() {
        var _this$_overlay2;
        return (null === (_this$_overlay2 = this._overlay) || void 0 === _this$_overlay2 || null === (_this$_overlay2 = _this$_overlay2.$content()) || void 0 === _this$_overlay2 ? void 0 : _this$_overlay2.find(".dx-menu-items-container")) ?? $()
    }
    ...
    _hideAllShownSubmenus() {
        var _this$_overlay3;
        const shownSubmenus = extend([], this._shownSubmenus);
        const $expandedItems = (null === (_this$_overlay3 = this._overlay) || void 0 === _this$_overlay3 || null === (_this$_overlay3 = _this$_overlay3.$content()) || void 0 === _this$_overlay3 ? void 0 : _this$_overlay3.find(".dx-menu-item-expanded")) ?? $();
        $expandedItems.removeClass("dx-menu-item-expanded");
