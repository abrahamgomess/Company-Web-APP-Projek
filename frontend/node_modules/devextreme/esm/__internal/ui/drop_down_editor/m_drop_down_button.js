...
export default class DropDownButton extends TextEditorButton {
    ...
    _attachEvents(instance) {
        ...
        eventsEngine.on(instance.$element(), "mousedown", (e => {
            var _this$editor5;
            if (null !== (_this$editor5 = this.editor) && void 0 !== _this$editor5 && null !== (_this$editor5 = _this$editor5.$element()) && void 0 !== _this$editor5 && _this$editor5.is(".dx-state-focused")) {
                e.preventDefault()
            }
        }))
    }
