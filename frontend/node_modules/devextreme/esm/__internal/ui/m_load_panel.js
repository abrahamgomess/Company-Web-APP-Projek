...
class LoadPanel extends Overlay {
    ...
    _renderContentImpl() {
        ...
        null === (_this$$content = this.$content()) || void 0 === _this$$content || _this$$content.addClass("dx-loadpanel-content");
    ...
    _cleanPreviousContent() {
        var _this$$content2, _this$$content3;
        null === (_this$$content2 = this.$content()) || void 0 === _this$$content2 || _this$$content2.find(".dx-loadpanel-message").remove();
        null === (_this$$content3 = this.$content()) || void 0 === _this$$content3 || _this$$content3.find(".dx-loadpanel-indicator").remove();
        delete this._$indicator
    }
    _togglePaneVisible() {
        var _this$$content4;
        null === (_this$$content4 = this.$content()) || void 0 === _this$$content4 || _this$$content4.toggleClass("dx-loadpanel-pane-hidden", !this.option("showPane"))
    }
    _optionChanged(args) {
        switch (args.name) {
            case "delay":
