...
class ActionSheet extends CollectionWidget {
    ...
    _createPopover() {
        var _this$_popup$$overlay, _this$_popup$$wrapper;
        this._createComponent(this._$popup, Popover, extend(this._overlayConfig(), {
            width: this.option("width") || 200,
            height: this.option("height") || "auto",
            target: this.option("target")
        }));
        null === (_this$_popup$$overlay = this._popup.$overlayContent()) || void 0 === _this$_popup$$overlay || _this$_popup$$overlay.attr("role", "dialog");
