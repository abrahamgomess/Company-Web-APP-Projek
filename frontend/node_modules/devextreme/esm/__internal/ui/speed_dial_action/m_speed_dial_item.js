...
class SpeedDialItem extends Overlay {
    ...
    _moveToContainer() {
        if (this._$wrapper) {
            ...
            null === (_this$_$content = this._$content) || void 0 === _this$_$content || _this$_$content.appendTo(this._$wrapper)
        }
    }
    _render() {
    ...
    _updateZIndexStackPosition() {
        var _this$_$wrapper, _this$_$content2;
        const {
            zIndex: zIndex
        } = this.option();
        null === (_this$_$wrapper = this._$wrapper) || void 0 === _this$_$wrapper || _this$_$wrapper.css("zIndex", zIndex);
        null === (_this$_$content2 = this._$content) || void 0 === _this$_$content2 || _this$_$content2.css("zIndex", zIndex)
    }
    _setClickAction() {
