...
class DiagramDialog extends Widget {
    ...
    _show() {
        var _this$_popup;
        null === (_this$_popup = this._popup) || void 0 === _this$_popup || null === (_this$_popup = _this$_popup.$content()) || void 0 === _this$_popup || _this$_popup.empty().append(this._onGetContentAction());
        this._popup.show();
        this._isShown = true
    }
    isVisible() {
